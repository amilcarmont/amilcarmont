# Hola, mi nombre es Amilcar Montañana 🧉
...
- [Ruta J](https://play.google.com/store/apps/details?id=com.amilcar.rutaj&hl=es_AR&gl=US) - Esta es una App de uso para los usuarios de una Distribuidora Eléctrica que entre sus principales funciones se pueden mencionar : Descarga de facturas desde un servidor web, posibilidad de conocer la evolución de su consumo, ver el estado de deuda on line, realizar pagos, simulador de consumos, notificaciones de eventos y facturas por vencer, contacto con la empresa mediante llamada, mail o whatsapp, link de interes y mucho más.
